...
@section('page-title') ویرایش کاربر {{$user->username}} @endsection
...
<nav>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"> ویرایش کاربر {{$user->username}} </li>
    </ol>
</nav>
@endsection
                        ...
                        <div class="row">
                            <div class="col-md-4 my-2">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('firstname',$user->firstname) }}" type="text" class="form-control mt-1" id="firstname" name="firstname"  required readonly />
                                </div>
                            </div>
                            <div class="col-md-4 my-2">
                                <div class="form-group">
                                    <label for="lastname"> نام خانوادگی </label>
                                    <input value="{{ old('lastname',$user->lastname) }}" type="text" class="form-control mt-1" id="lastname" name="lastname" />
                                </div>
                            </div>
                            <div class="col-md-4 my-2">
                                <div class="form-group">
                                    <label for="username"> نام کاربری <span class="text-danger">*</span></label>
                                    <input value="{{ old('username',$user->username) }}" type="text" class="form-control mt-1 avash-direction-ltr" id="username" name="username"  required  readonly />
                                </div>
                            </div>
                            <div class="col-md-4 my-2">
                                <div class="form-group">
                            ...
                            <div class="col-md-4 my-2">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('mobile',$user->mobile) }}" type="text" class="form-control mt-1 avash-direction-ltr" id="mobile" name="mobile" />
                                </div>
                            </div>
                            <div class="col-md-4 my-2">
                                <div class="form-group">
                                    <label for="email"> آدرس ایمیل </label>
                                    <input value="{{ old('email',$user->email) }}" type="text" class="form-control mt-1 avash-direction-ltr" id="email" name="email" />
                                </div>
                            </div>
                            <div class="col-md-4 my-2">
                                <div class="form-group">
                                    <label for="nationalcode"> کدملی </label>
                                    <input value="{{ old('nationalcode',$user->nationalcode) }}" type="text" class="form-control mt-1 avash-direction-ltr" id="nationalcode" name="nationalcode" />
                                </div>
                            </div>
                            <div class="col-md-4 my-2">
                                <div class="form-group">
                                        ...
                                        @foreach($userPermissions as $permissionId)
                                            @foreach($permissions as $permission)
                                                @if($permission->id == $permissionId)
                                                    <li onclick="moveToAll(this)" data-id="{{ $permission->id }}" style="cursor:pointer; border-bottom: 1px solid #000; padding: 3px 0">
                                                        {{ $permission->persian_title }}
                                                    </li>
                                                @endif
                                            @endforeach
                            ...
                            <div class="col-md-4 my-2">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('password') }}" type="password" class="form-control mt-1 avash-direction-ltr" id="password" name="password"  />
                                </div>
                            </div>
                            <div class="col-md-4 my-2">
                                <div class="form-group">
                                    <label for="password_confirmation"> تکرار کلمه عبور </label>
                                    <input value="{{ old('password_confirmation') }}" type="password" class="form-control mt-1 avash-direction-ltr" id="" name="password_confirmation"  />
                                </div>
                            </div>
