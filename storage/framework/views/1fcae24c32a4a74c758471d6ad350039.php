...
<head>
  ...
  <title> ورود به پنل مدیریت | <?php echo e(env('APP_NAME')); ?> </title>
  ...
  <!-- Vendor CSS Files -->
  <link href="<?php echo e(asset('admin-assets/assets/vendor/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet">
  <link href="<?php echo e(asset('admin-assets/assets/vendor/bootstrap-icons/bootstrap-icons.css')); ?>" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link href="<?php echo e(asset('admin-assets/assets/css/style.css')); ?>" rel="stylesheet">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <?php endif; ?>
                  <form class="row g-3" method="POST" action="<?php echo e(route('login.submit')); ?>" >
                    <?php echo csrf_field(); ?>
                    <div class="col-12">
...
</html><?php /**PATH C:\xampp\htdocs\panel\cms\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>